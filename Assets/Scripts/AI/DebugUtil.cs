...
public static class DebugUtil
{
	...
	// Draw a V-shape ray, but also visible in the Scene view when the game is not running
	public static void DrawNavigationRay(Vector3 origin, Vector3 direction, Color color, float duration = 0, bool depthTest = true)
	{
